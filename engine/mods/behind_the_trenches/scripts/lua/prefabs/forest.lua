local assets =
{
	...
	Asset("SCRIPT", "scripts/lua/prefabs/brokenwalls.lua"),
	Asset("SCRIPT", "scripts/lua/prefabs/player_common.lua"),
	Asset("SCRIPT", "scripts/lua/prefabs/paired_maxwelllight.lua"),
	Asset("SCRIPT", "scripts/lua/prefabs/phonograph.lua"),
	Asset("SCRIPT", "scripts/lua/prefabs/unlockable_players.lua"),
	Asset("SCRIPT", "scripts/lua/prefabs/devtool.lua"),
	Asset("SCRIPT", "scripts/lua/prefabs/nightlight_flame.lua"),
	Asset("SCRIPT", "scripts/lua/prefabs/stairs.lua"),
	Asset("SCRIPT", "scripts/lua/prefabs/tree_clump.lua"),
	Asset("SCRIPT", "scripts/lua/prefabs/devtool.lua"),
	Asset("SCRIPT", "scripts/lua/prefabs/researchmachine.lua"),
	Asset("SCRIPT", "scripts/lua/prefabs/ruin.lua"),
