...
package.path = "..\\DLC0001\\scripts\\lua\\?.lua;?.lua"
...
function CreateStringsPOTv1(filename, root, tbl_dta, tbl_lkp)
	filename = filename or "data\\scripts\\lua\\languages\\temp_v1.pot"
...
function CreateStringsPOTv2(filename, root, tbl_dta, tbl_lkp)
	filename = filename or "data\\DLC0001\\scripts\\lua\\languages\\temp_v2.pot"
	root = root or "STRINGS"
...
--if BRANCH == "release" then
	...
	CreateStringsPOTv2("..\\DLC0001\\scripts\\lua\\languages\\strings.pot", "STRINGS", STRINGS)
