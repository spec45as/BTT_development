...
local CharacterSelectScreen = Class(Screen, function(self, profile, cb, no_backbutton, default_character)
	...
	-- TODO BDOIG : REMOVE THIS ONCE ALL SW CHARACTERS ARE IN
	if IsDLCEnabled(CAPY_DLC) then
		table.insert(self.characters, "hidden")
   	end
...
function CharacterSelectScreen:SelectPortrait(portrait)
	...
	if character == "hidden" then --TODO BDOIG : REMOVE THIS ONCE ALL SW CHARACTERS ARE IMPLEMENTED
	...
	elseif character and self.profile:IsCharacterUnlocked(character) then
