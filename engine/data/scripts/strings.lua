...
STRINGS=
{
    ...
    CHARACTER_QUOTES =
    {
        ...
        walani = "\"Can someone bring me some food?\"",
        warly = "\"Bon Appetit!\"",
        wilbur = "...",
    ...
    CHARACTER_DESCRIPTIONS =
    {
        ...
        warly = "*Has distinguished tastes\n*Cooks in custom cookware\n*Has a stylish chef pouch",
        wilbur = "*Can't talk\n*Can run\n*Is a monkey",
...
---------------------- Capy DLC Strings------------------
    ...
    RECIPE_DESC=
    {
        ...
        SURFBOARD = "Hang ten!",
        DOUBLE_UMBRELLAHAT = "Function definitely over fashion.",
...
STRINGS.UI =
{
    ...
    MAINSCREEN =
    {
        ...
        SHIPWRECKED_UPDATENAME = "Wilbur vs. The Volcano",
        CONTROLS = "Controls",
    ...
    SAVEINTEGRATION = 
    {
        ...
        EARLY_ACCESS = "This feature is still in Early Access, so errors might occur and data might get corrupted. \n Are you sure you want to continue?",
