...
local function MakePlayerCharacter(name, customprefabs, customassets, customfn, starting_inventory)
    ...
    local fn = function(Sim)  
        ...
        anim:SetBank("unknown")
        anim:SetBuild("unknown")
        anim:PlayAnimation("unknown")
		...
		inst.components.locomotor.walkspeed = 8 -- 4
		inst.components.locomotor.runspeed = 12 -- 6
