local assets =
{
	...
	--=BTT content
	Asset("ATLAS", "images/btt/btt_logo.xml"),
    Asset("IMAGE", "images/btt/btt_logo.tex"),
	Asset("ATLAS", "images/btt/btt_main_menu.xml"),
    Asset("IMAGE", "images/btt/btt_main_menu.tex"),
