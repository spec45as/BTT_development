return {
	...
	{		
        ...
        FLOTSAM = "Someone wrecked the set!",
        SUNKEN_BOAT =
        {
        	GENERIC = "A true warrior goes down with their boat.",
        	ABANDONED = "I wonder where he has gone?",
		},

        SUNKEN_BOAT_BURNT = "What a tragedy!",

   		SUNKEN_BOAT_TRINKET_1 = "A tool of the seas.", --sextant
		SUNKEN_BOAT_TRINKET_2 = "A tiny longship.", --toy boat
		SUNKEN_BOAT_TRINKET_3 = "That won't be of much use.", --candle
		SUNKEN_BOAT_TRINKET_4 = "A... er... device.", --sea worther
		SUNKEN_BOAT_TRINKET_5 = "Worn battle armour.", --boot
